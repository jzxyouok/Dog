    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="__APP__/Baike/usave" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <input type="hidden"  name="baikeId" value="<?php echo ($arr["baikeId"]); ?>"/>
