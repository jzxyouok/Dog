            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($fabuArr)): foreach($fabuArr as $key=>$v): ?><tr>
							<td><?php echo ($v["type"]); ?></td>
							<td><img width="180" src="__PUBLIC__/upload/<?php echo ($v["image"]); ?>" /></td>
							<td><?php echo mystr($v['description'],0,60,"utf-8","...");?></td>
							<td><?php echo ($v["addTime"]); ?></td>
							<td>
								<a href="__APP__/Fabu/detail/id/<?php echo ($v["fabuId"]); ?>">查看</a>&nbsp;|&nbsp;
								<a href="__APP__/Fabu/update/id/<?php echo ($v["fabuId"]); ?>">更改</a>&nbsp;|&nbsp;
								<a href="__APP__/Fabu/del/id/<?php echo ($v["fabuId"]); ?>">删除</a>
							</td>
