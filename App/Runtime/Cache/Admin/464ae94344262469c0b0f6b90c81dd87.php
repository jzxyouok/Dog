            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($zhidaoArr)): foreach($zhidaoArr as $key=>$v): ?><tr>
							<td><?php echo ($v["title"]); ?></td>
							<td><?php echo mystr($v['content'],0,60,"utf-8","...");?></td>
							<td><?php echo ($v["addTime"]); ?></td>
							<td>
								<a href="__APP__/Zhidao/detail/id/<?php echo ($v["zhidaoId"]); ?>">查看</a>&nbsp;|&nbsp;
								<a href="__APP__/Zhidao/update/id/<?php echo ($v["zhidaoId"]); ?>">更改</a>&nbsp;|&nbsp;
								<a href="__APP__/Zhidao/del/id/<?php echo ($v["zhidaoId"]); ?>">删除</a>
							</td>
