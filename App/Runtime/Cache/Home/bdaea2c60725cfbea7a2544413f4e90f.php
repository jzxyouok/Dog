	...
	<body>
				...
				<div class="container">
					<div class="service-list">
						...
						<div class="gallery-grids" >
							<?php if(is_array($fabuArr)): foreach($fabuArr as $key=>$v): ?><a href="__APP__/Home/Renling/detail/b/<?php echo ($v["fabuId"]); ?>">
		...
		<!--contact-->
			<div class="contact-page">
				<h3>萌犬认领</h3>
				<div class="container">
					<form method="post" action="__APP__/Admin/Renling/save">
					<div class="feed-back">
						<div class="col-md-6 tt">
						<div class="text-area">
							<textarea name="content" value="请输入你的信息:" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '请输入你的信息：';}">请输入你的信息</textarea>
						</div>
						</div>
						<div class="col-md-6 tt brk9">
						<div class="form">
							
								<input class="name" type="text" name="name" value="你的名字" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '你的名字';}"><br>
								<br>
								<input class="nuber" type="text" name="tel" value="Tel" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '电话';}"><br>
								<br>
