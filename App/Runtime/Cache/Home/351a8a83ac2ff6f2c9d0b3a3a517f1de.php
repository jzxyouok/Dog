		...
		<!--about-->
			...
			<div class="container">
					<div class="col-md-6 lt">
						<div class="choose-us">
							<h4>萌犬在日常生活中会遇到哪些问题呢?</h4>
							<ul>
								<?php if(is_array($docArr)): foreach($docArr as $key=>$v): ?><li class="text-ul">
									<div class="folt">
									<h4><a href="__APP__/Home/Index/detail/d/<?php echo ($v["docId"]); ?>"><?php echo ($v["title"]); ?></a></h4>
									</div>
									<div class="clearfix"></div>
						...
						<div class="few-words">
							<h3>狗狗遇到的问题实例</h3>
								<div class="few-text">
									...
									<div class="flt">
									<h4>母狗产后呼吸急促并且不停的吐舌头</h4>
									<p>医生，您好，我家狗狗在昨天中午产完两只小狗，一切正常，但是昨天傍晚出现了呼吸急促并且吐舌头，很像她产前的表现，我当时怀疑她还有狗狗要生，到了夜晚，排出了绿色液体，黑色液体稍微浓厚些，体温也很高，直到今天也是这种情况，请问这种情况是子宫在恢复还是什么疾病？谢谢！</p>
